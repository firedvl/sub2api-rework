  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '欢迎使用 Gateway',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 12px;">通过服务分组和受管账号池配置请求路由。</p><p>本指南将介绍分组、上游账号和 API 密钥。</p></div>',
        nextBtn: '开始配置',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">分组用于定义路由和计费规则：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>每个分组可以包含多个上游账号</li><li>每个分组有独立的计费倍率</li><li>分组可以设为公开或专属</li></ul><p style="margin-top: 16px; color: #10b981; font-weight: 600;">点击侧边栏中的“分组管理”</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '欢迎使用 Gateway',
        description:
          '<div style="line-height: 1.8;"><p>创建 API 密钥，然后连接兼容 OpenAI 的客户端。</p></div>',
        nextBtn: '开始',
        prevBtn: '跳过'
      },
      keyManage: {
