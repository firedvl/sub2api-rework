export default {
    ...
    dashboard: {
      ...
      capacity: {
        ...
        byProvider: '按供应商查看容量',
        poolTitle: '当前账号池容量',
        poolDescription: '按账号归一化已知供应商额度；每个账号采用最低的有效限制，未知额度不计入结果。',
        poolAvailable: '可用',
        poolUsed: '已用容量',
        poolUsedValue: '已用容量 {value}%',
        poolNormalized: '归一化账号池',
        poolContribution: '占账号池 {value}%',
        poolLegend: '归一化账号池明细',
        poolUnknownExcluded: '已排除 {count} 个未知额度',
        loading: '正在加载账号容量...',
        loadFailed: '额度快照不可用',
        empty: '当前视图没有账号。',
        providerAccounts: '{count} 个账号',
        normalizedRemaining: '归一化剩余 {value}%',
        providerCapacityAria: '{provider}：{remaining}；{known} 个已知，{unknown} 个未知',
        quotaCoverage: '额度覆盖',
        lowestCapacity: '最低容量',
        nextReset: '下次重置',
        lowestRemaining: '最低剩余',
        lowestAccountRemaining: '最低 {value}% - {account}',
        nextLimitingReset: '下一个限制重置时间 {time}',
        remaining: '剩余 {value}%',
        used: '已用 {value}%',
        resets: '{time} 重置',
        noReset: '不自动重置',
