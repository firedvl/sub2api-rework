export default {
    settings: {
      ...
      updates: {
        ...
        runningGatewayValue: '运行中的 Gateway：{version}',
        runningGateway: '运行中的 Gateway',
        runningRevision: '运行版本提交',
        embeddedUpstream: '内置 Sub2API 基线',
        embeddedUpstreamRevision: '上游基线提交',
        latestRework: '最新 Rework',
        latestUpstream: '最新上游稳定版',
        upstreamSyncStatus: '上游同步状态',
        upstreamSyncCurrent: '已同步',
        upstreamSyncAvailable: '可同步',
