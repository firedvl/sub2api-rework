export default {
    accounts: {
      ...
      bulkImportTitle: '批量导入账号',
      bulkImportSteps: '批量导入步骤',
      bulkImportAdd: '添加账号',
      bulkImportReview: '检查',
      bulkImportImport: '导入',
      bulkImportResults: '结果',
      bulkImportAddHint: '粘贴账号数据、选择文件或拖放 JSON / JSONL 文件。凭据仅保留在此对话框内。',
      bulkImportPaste: '粘贴账号数据',
      bulkImportPastePlaceholder: '导出的 JSON、单个账号 JSON、账号数组或每行一个 JSON 账号',
      bulkImportDropHint: '将 .json 或 .jsonl 文件拖到这里',
      bulkImportParseIssues: '{count} 行格式错误，不会导入',
      bulkImportMalformed: '输入行格式错误',
      bulkImportNoAccounts: '请至少添加一个有效账号后再检查',
      bulkImportPreviewing: '检查中...',
      bulkImportPreviewFailed: '无法预览本次导入',
      bulkImportRevalidate: '重新验证',
      bulkImportTotal: '总数',
      bulkImportReady: '可导入',
      bulkImportDuplicates: '重复',
      bulkImportInvalid: '无效',
      bulkImportStatus: '状态',
      bulkImportIdentity: '标识',
      bulkImportMessage: '说明',
      bulkImportProgress: '已导入 {completed} / {total}',
      bulkImportCreated: '已创建',
      bulkImportUpdated: '已更新',
      bulkImportSkipped: '已跳过',
      bulkImportFailed: '失败',
      bulkImportSuccessful: '成功',
      bulkImportRetryFailed: '重试失败项',
      bulkImportKeepSource: '保留导入值',
      bulkImportDisabled: '禁用',
      bulkImportOverrideSchedulable: '覆盖调度设置',
      bulkImportTransportFailed: '导入请求未完成，请重试该行。',
