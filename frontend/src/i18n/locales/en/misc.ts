  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        ...
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 12px;">Configure routing through service groups and managed account pools.</p><p>This guide covers groups, upstream accounts, and API keys.</p></div>',
        nextBtn: 'Start setup',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Groups define routing and billing rules:</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>Each group can contain multiple upstream accounts</li><li>Each group has an independent billing multiplier</li><li>Groups can be public or exclusive</li></ul><p style="margin-top: 16px; color: #10b981; font-weight: 600;">Click "Group Management" in the sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: 'Welcome to Gateway',
        description: '<div style="line-height: 1.8;"><p>Create an API key and connect an OpenAI-compatible client.</p></div>',
        nextBtn: 'Start',
        prevBtn: 'Skip'
      },
      keyManage: {
