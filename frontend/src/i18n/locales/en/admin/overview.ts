export default {
    ...
    dashboard: {
      ...
      capacity: {
        ...
        warningCount: '{count} warning | {count} warnings',
        unavailableCount: '{count} unavailable',
        knownCount: '{count} with quota',
        unknownCount: '{count} unknown',
        byProvider: 'Capacity by provider',
        poolTitle: 'Current account pool capacity',
        poolDescription: 'Known provider quotas are normalized per account. Each account uses its lowest active limit; unknown quotas are excluded.',
        poolAvailable: 'available',
        poolUsed: 'Used capacity',
        poolUsedValue: '{value}% used capacity',
        poolNormalized: 'Normalized account pool',
        poolContribution: '{value}% of pool',
        poolLegend: 'Normalized account pool breakdown',
        poolUnknownExcluded: '{count} unknown excluded',
        ...
        normalizedRemaining: '{value}% normalized remaining',
        providerCapacityAria: '{provider}: {remaining}; {known} known; {unknown} unknown',
        quotaCoverage: 'Quota coverage',
        lowestCapacity: 'Lowest capacity',
        nextReset: 'Next reset',
        lowestRemaining: 'Lowest remaining',
        lowestAccountRemaining: 'Lowest {value}% - {account}',
        nextLimitingReset: 'Next limiting reset {time}',
        ...
        plan: 'Plan',
        modelCount: '{count} model mapping | {count} model mappings',
        routing: 'Routing:',
        ...
        createdAt: 'Created',
        updatedAt: 'Updated',
        modelMappings: 'Configured model mappings',
    ...
    groups: {
      ...
      modelsList: {
        title: 'Model List',
        hint: 'Choose the models shown by /v1/models for this group.',
