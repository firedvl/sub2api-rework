export default {
    accounts: {
      ...
      bulkImportTitle: 'Bulk Account Import',
      bulkImportSteps: 'Bulk import steps',
      bulkImportAdd: 'Add accounts',
      bulkImportReview: 'Review',
      bulkImportImport: 'Import',
      bulkImportResults: 'Results',
      bulkImportAddHint: 'Paste accounts, choose files, or drop JSON / JSONL files. Credentials remain in this dialog only.',
      bulkImportPaste: 'Paste account data',
      bulkImportPastePlaceholder: 'Exported JSON, account JSON, account array, or one JSON account per line',
      bulkImportDropHint: 'Drop .json or .jsonl files here',
      bulkImportParseIssues: '{count} malformed row(s) will not be imported',
      bulkImportMalformed: 'Malformed input row',
      bulkImportNoAccounts: 'Add at least one valid account before reviewing',
      bulkImportPreviewing: 'Checking...',
      bulkImportPreviewFailed: 'Could not preview this import',
      bulkImportRevalidate: 'Revalidate',
      bulkImportTotal: 'Total',
      bulkImportReady: 'Ready',
      bulkImportDuplicates: 'Duplicates',
      bulkImportInvalid: 'Invalid',
      bulkImportStatus: 'Status',
      bulkImportIdentity: 'Identity',
      bulkImportMessage: 'Message',
      bulkImportProgress: 'Imported {completed} of {total}',
      bulkImportCreated: 'Created',
      bulkImportUpdated: 'Updated',
      bulkImportSkipped: 'Skipped',
      bulkImportFailed: 'Failed',
      bulkImportSuccessful: 'Successful',
      bulkImportRetryFailed: 'Retry Failed',
      bulkImportKeepSource: 'Keep imported value',
      bulkImportDisabled: 'Disabled',
      bulkImportOverrideSchedulable: 'Override scheduling',
      bulkImportTransportFailed: 'Import request did not complete. Retry this row.',
      ...
      openai: {
        ...
        capabilityVisionInput: 'Vision input',
