export default {
  stats: {
    ...
    capacity: {
      ...
      averageLimitingQuota: 'Average of each account’s limiting quota · not pooled capacity',
      mixedAverageLimitingQuota: 'Mixed providers · average of each account’s limiting quota · not pooled capacity',
