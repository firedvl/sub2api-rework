export default {
    settings: {
      ...
      updates: {
        ...
        runningGatewayValue: 'Running Gateway: {version}',
        runningGateway: 'Running Gateway',
        runningRevision: 'Running revision',
        embeddedUpstream: 'Embedded Sub2API baseline',
        embeddedUpstreamRevision: 'Upstream baseline revision',
        latestRework: 'Latest Rework',
        latestUpstream: 'Latest upstream stable',
        upstreamSyncStatus: 'Upstream sync status',
        upstreamSyncCurrent: 'Current',
        upstreamSyncAvailable: 'Sync available',
