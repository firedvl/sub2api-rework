      ...
      <div class="flex flex-1 flex-wrap items-end gap-4">
        ...
        <div ref="userSearchRef" class="usage-filter-dropdown relative w-full sm:w-auto sm:min-w-[240px]">
          ...
          <div
            ...
            class="operator-menu absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-lg border bg-white shadow-lg dark:bg-dark-800"
          >
            <button
              ...
              type="button"
              @click="selectUser(u)"
              class="operator-menu-item w-full px-4 py-2 text-left hover:bg-gray-100 dark:hover:bg-dark-700"
            >
