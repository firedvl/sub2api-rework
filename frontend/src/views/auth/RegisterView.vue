...
import { OPERATOR_PRODUCT_NAME, resolveOperatorProductName } from '@/utils/branding'
import {
...
const siteName = ref<string>(OPERATOR_PRODUCT_NAME)
...
onMounted(async () => {
  ...
  try {
    ...
    siteName.value = resolveOperatorProductName(settings.site_name)
