...
func RegisterAdminRoutes(
	...
	admin.Use(middleware.AdminComplianceGuard(settingService))
	{
		...
		// 系统管理
		registerSystemRoutes(admin, h, strictStepUpAuth)
...
func registerGroupRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	groups := admin.Group("/groups")
	{
		...
		groups.GET("/:id/model-operations", h.Admin.Group.GetModelOperations)
		groups.GET("/:id/model-allowlist-candidates", h.Admin.Group.GetModelsListCandidates)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/:id/vision-qualification", h.Admin.Account.GetOpenAIVisionQualification)
		accounts.POST("/:id/vision-qualification", h.Admin.Account.RunOpenAIVisionQualification)
		accounts.POST("/:id/vision-qualification/promote", h.Admin.Account.PromoteOpenAIVisionQualification)
...
func registerSystemRoutes(admin *gin.RouterGroup, h *handler.Handlers, strictStepUpAuth middleware.StrictStepUpAuthMiddleware) {
