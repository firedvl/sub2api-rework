...
const (
	...
	// SettingKeyOpenAIAutoWarmupEnabled controls the global OpenAI OAuth Auto Warm-up master switch.
	SettingKeyOpenAIAutoWarmupEnabled = "openai_auto_warmup_enabled"
