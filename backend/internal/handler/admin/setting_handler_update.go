...
type UpdateSettingsRequest struct {
	...
	OpenAIAutoWarmupEnabled                            *bool    `json:"openai_auto_warmup_enabled"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		OpenAIAutoWarmupEnabled: func() bool {
			if req.OpenAIAutoWarmupEnabled != nil {
				return *req.OpenAIAutoWarmupEnabled
			}
			return previousSettings.OpenAIAutoWarmupEnabled
		}(),
	...
	payload := dto.SystemSettings{
		...
		OpenAIAutoWarmupEnabled:                                updatedSettings.OpenAIAutoWarmupEnabled,
