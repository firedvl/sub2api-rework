...
func setupAdminRouter() (*gin.Engine, *stubAdminService) {
	...
	router.GET("/api/v1/admin/groups/:id/model-allowlist-candidates", groupHandler.GetModelsListCandidates)
...
func TestGroupHandlerEndpoints(t *testing.T) {
	...
	require.Contains(t, rec.Body.String(), `"endpoint":"alpha_search"`)
	...
	body, _ = json.Marshal(map[string]any{"model": "gpt-5", "endpoint": "alpha_search"})
	rec = httptest.NewRecorder()
