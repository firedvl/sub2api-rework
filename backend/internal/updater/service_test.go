...
func TestUpdater113PreparesRework7FromRework3(t *testing.T) {
	runner := &fakeRunner{}
	...
	manifest.ReworkVersion = "0.1.183-rework.7"
	manifest.Image = "ghcr.io/firedvl/sub2api-rework:0.1.183-rework.7"
