...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	operatorAssistantService := service.ProvideOperatorAssistantService(adminService, dashboardService, opsService, gatewayService, openAIGatewayService, antigravityGatewayService, serviceBuildInfo)
	operatorAssistantHandler := admin.NewOperatorAssistantHandler(operatorAssistantService)
	...
	groupHandler := admin.NewGroupHandler(adminService, dashboardService, groupCapacityService, gatewayService, openAIGatewayService, configConfig)
	...
	openAIAutoWarmupAttemptRepository := repository.NewOpenAIAutoWarmupAttemptRepository(db)
	openAIQuotaAutoResetService := service.ProvideOpenAIQuotaAutoResetService(accountRepository, openAIQuotaService, rateLimitService, idempotencyCoordinator, auditLogService, settingService, leaderLockCache, openAIAutoWarmupAttemptRepository, openAIGatewayService, pluginManager)
