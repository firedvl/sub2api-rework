...
| Codex client tools | In progress | Namespace and custom-tool compatibility is being validated |
| Standalone Codex web search | Planned | Protocol research and implementation are tracked separately |
