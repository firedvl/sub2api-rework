...
| `updater/` | Restricted updater policy, Compose override, and hardened systemd unit examples |
...
| `SUB2API_IMAGE` | No | `weishaw/sub2api:latest` | Application image; the restricted updater pins this to an approved digest. |
